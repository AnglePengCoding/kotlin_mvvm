...
import com.github.anglepengcoding.kt_mvvm.ext.IntentFieldMethod.internalMap
...
class GhostFragment : Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == this.requestCode) {
            val result =
                if (resultCode == FragmentActivity.RESULT_OK && data != null) data else null
