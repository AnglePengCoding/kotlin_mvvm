package com.github.anglepengcoding.kt_mvvm.weight.tab;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public void setViewPager(ViewPager vp, ArrayList Titles) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
        this.mViewPager = vp;
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                //选中后文字变大
                tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, isSelect ? mTextsize+12f :mTextsize);
                //选中后文字变粗
    ...
    public void showMsg(int position, int num) {
        ...
        if (tipView != null) {
            UnreadMsgUtils.INSTANCE.show(tipView, num);
